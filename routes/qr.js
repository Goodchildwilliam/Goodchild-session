...
router.get('/', async (req, res) => {
    ...
    async function GOODCHILD_QR_CODE() {
        ...
        try {
            ...
            title: '',
            text: 'Gifted~' + b64data,
            footer: `> *𝐏𝐎𝐖𝐄𝐑𝐄𝐃 ʙʏ 𝐆𝐎𝐎𝐃𝐂𝐇𝐈𝐋𝐃𝐖𝐈𝐋𝐋𝐈𝐀𝐌𝐙*`,
            buttons: [
                { 
                    name: 'cta_copy', 
                    buttonParamsJson: JSON.stringify({ 
                        display_text: 'Copy Session', 
                        copy_code: 'Goodchild~' + b64data 
                    }) 
                },
                {
                    name: 'cta_url',
                    buttonParamsJson: JSON.stringify({
                        ...
                        url: 'https://github.com/Goodchildwilliam/GOODCHILD-MD'
                    })
                },
                {
                    name: 'cta_url',
                    buttonParamsJson: JSON.stringify({
                        ...
                        url: 'https://whatsapp.com/channel/09Vb3hlgX5kg7G0nFggl0Y'
                    })
                }
            ]
        });
