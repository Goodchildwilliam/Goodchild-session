...
- This is what I use in my **[Session Site](Https://github.com/Goodchildwilliam)** so don't ask for more...
...
async function loadSession() {
    try {
        ...
        if (header !== "Goodchild" || !b64data) {
            throw new Error("❌ Invalid session format. Expected 'Goodchild~.....'");
        }
...
[![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/colored.png)](#table-of-contents)
<p align="center">
   <a href="https://github.com/Goodchildwilliam">
    <img src="https://files.catbox.moe/cl3ra4.jpg" width="500">
...
[`ℹ️Contact Owner`](https://wa.me/255792375563)
 <br>
<a href='https://github.com/Goodchildwilliam/goodchild-session/fork' target="_blank">
...
<a href='https://dashboard.heroku.com/new?template=https://github.com/Goodchildwilliam/goodchild-session' target="_blank"><img alt='HEROKU DEPLOY' src='https://img.shields.io/badge/-HEROKU DEPLOY-black?style=for-the-badge&logo=heroku&logoColor=white'/>
 <br>
